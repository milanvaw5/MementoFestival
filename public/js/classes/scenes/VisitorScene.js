...
let jointPositionsGebruikers = {
  leftEyePos: {x:startPos, y:startPos},
  leftWristPos: {x:startPos, y:startPos},
  rightWristPos: {x:startPos, y:startPos},
  leftShoulderPos: {x:startPos, y:startPos},
  rightShoulderPos: {x:startPos, y:startPos},
  leftElbowPos: {x:startPos, y:startPos},
  rightElbowPos: {x:startPos, y:startPos},
  leftKneePos: {x:startPos, y:startPos},
  rightKneePos: {x:startPos, y:startPos},
  leftHipPos: {x:startPos, y:startPos},
  rightHipPos: {x:startPos, y:startPos},
  leftAnklePos: {x:startPos, y:startPos},
  rightAnklePos: {x:startPos, y:startPos}
}
let jointPositionsGebruikersTarget = {
  leftEyePosTarget: {x:startPos, y:startPos},
  leftWristPosTarget: {x:startPos, y:startPos},
  rightWristPosTarget: {x:startPos, y:startPos},
  leftShoulderPosTarget: {x:startPos, y:startPos},
  rightShoulderPosTarget: {x:startPos, y:startPos},
  leftElbowPosTarget: {x:startPos, y:startPos},
  rightElbowPosTarget: {x:startPos, y:startPos},
  leftKneePosTarget: {x:startPos, y:startPos},
  rightKneePosTarget: {x:startPos, y:startPos},
  leftHipPosTarget: {x:startPos, y:startPos},
  rightHipPosTarget: {x:startPos, y:startPos},
  leftAnklePosTarget: {x:startPos, y:startPos},
  rightAnklePosTarget: {x:startPos, y:startPos}
}
